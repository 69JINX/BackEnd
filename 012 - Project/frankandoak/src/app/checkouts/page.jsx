...
function page() {
    ...
    const [paymentDetails, setPaymentDetails] = useState({ first_name: '', last_name: '', address: '', telephone: '', country: "India", postal_code: '' });
            ...
            <div className='checkout w-100 h-25 d-md-flex justify-content-end'>
                ...
                <div className='PaymentDetails px-4'>
                    ...
                    <div className='my-3 d-flex'>
                        <input type="text" className='form-control w-75 py-2' placeholder='Address' name="address" onChange={(e) => setPaymentDetails({ ...paymentDetails, address: e.target.value })} />
                        <input type="text" className='form-control w-25 ms-2 py-2' placeholder='ZipCode' name="postal_code" onChange={(e) => setPaymentDetails({ ...paymentDetails, postal_code: e.target.value })} />
                    </div>
                    <div className='my-3'>
                        ...
                        <ul className='list-group'>
                            {
                                cart && cart.map((cartProduct) => (
                                    <li className='list-group-item border-0 bg-transparent p-3 d-flex'>
